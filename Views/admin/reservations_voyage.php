...
<body>
                  ...
                  <div class="card card-rounded">
                    <div class="card-body">
                      <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title card-title-dash title">Liste des reservations de voyage</h4>
                        </div>
                      </div>
                ...
                <div class="modal-dialog">
                  <form class="modal-content alert alert-warning" method="post" action="../../Controllers/scripts/change-status.php">
                    ...
                    <div class="modal-footer p-2">
                      <button type="submit" name="voyage" class="btn btn-warning mb-0">Confirmer</button>
  ...
  <script>
    ...
    function send_ajax_request (status) {
      ...
      $.ajax({
        url: '../../Controllers/scripts/reservations-voyage.php',
        type: 'POST',
